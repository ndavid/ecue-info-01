"""Vérifie que la version boucle et la version numpy de chaque effet donnent la même image.

    python test_effet.py

À lancer dans le dossier du projet (le décor est lu dans `decor/`) ; doit
afficher `True` sur chaque ligne.
"""
