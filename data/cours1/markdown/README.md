# Formatage en Markdown, et comparaison de versions — Cours 1

Le dossier sert à deux manipulations : la mise en forme d'un texte brut en
...
Manipulation d'annexe, qui prépare le cours 2. Le point de départ est un geste
...
### Ce que la manipulation prépare
...
installer, et la manipulation tourne dans n'importe quel environnement Python.
