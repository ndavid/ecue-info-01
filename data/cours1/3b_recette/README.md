# Un projet Python : la recette à l'échelle — TD 3b, cours 1
...
les unes et les autres. Ce dossier en est un, petit mais complet, et le
TD consiste à l'installer, à s'en servir, puis à compléter sa
documentation.
...
`markdown`, dont le code a besoin, s'installe pendant le TD. C'est
