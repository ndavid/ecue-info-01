# Une vidéo, deux chemins — TD 5b, cours 1, facultatif
...
ignorés par git. `carte.png` est fabriqué par l'enseignant, dans `produit/`,
et livré aux étudiants ; les images d'étape et la vidéo naissent à côté
d'`anime.sh`, là où l'étudiant le lance.
...
TD ailleurs ; les coordonnées d'`etapes.csv` sont alors à refaire.
