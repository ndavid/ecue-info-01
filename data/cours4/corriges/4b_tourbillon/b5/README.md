...
```
tourbillon vague.jpg --maximum 360
```
...
```
tourbillon vague.jpg --maximum 360 --video --cadence 12 --nettoyer
```

écrit `sortie/tourbillon.mp4` ; `--nettoyer` supprime ensuite `sortie/images/`.

`tourbillon --help` affiche toutes les options.
