---
title: Sur un ordinateur personnel
...
d'administrateur. Puis suivre [VS Code](vscode.md) et [Python et environnement
...
conda-forge git` dans un environnement fonctionne aussi.
