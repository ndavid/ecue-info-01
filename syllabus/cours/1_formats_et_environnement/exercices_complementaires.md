...
> Données : `cours1/1a_formats/` — dans le dépôt, `data/cours1/1a_formats/produit/`, fabriqué par `python make_data.py fetch && python make_data.py build`.
...
- **Prérequis** : TD 1a, « un texte, quatre formes » (étapes 1–2).
