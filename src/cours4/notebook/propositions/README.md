...
| `chat_en_ronds.md` | un chat dessiné forme par forme, une ligne de texte par forme (texte écrit pour l'occasion, six lignes), puis la queue qui bouge ; 21 s | les mêmes gestes, moins de formes, l'ordre d'empilement des `-draw`, `polygon` |
