...
```bash
python outils/compiler_diapos.py --cours 5                  # 47 pages : 37 d'exposé, 10 de TD
...
python outils/compiler_diapos.py --cours 5 --sans-tds       # 40 pages, un sommaire par bloc de TD
